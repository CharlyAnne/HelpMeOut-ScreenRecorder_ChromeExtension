      ...
      <div className="min-h-screen flex flex-col  ">
        ...
        <div className=" flex flex-col items-center justify-center ">
          <div className="bg-white p-8 rounded-lg w-full md:w-[500px]">
            ...
            <div className="flex flex-col justify-center items-start space-x-4 gap-4 mt-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-4">
              ...
              <div className="flex w-full justify-between items-center">
                <Link href="/home">
                  <button
                    type="submit"
                    className="w-full bg-[#120B48] text-white font-semibold py-4 text-[1.2rem] px-5 rounded-md focus:outline-none "
                  >
                    Sign Up
                  </button>
                </Link>
