  ...
  return (
    <section id="features" className="py-16 px-4 lg:px-16 xl:px-48">
      <div className="max-w-screen-xl mx-auto text-center mb-10">
        ...
        <p className="text-lg text-[#616163]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2  gap-8">
        <section>
          {data.map((item) => (
            <div
              key={item.id}
              className="bg-white rounded-lg gap-4 p-6 flex items-start "
            >
              <Image
                src={item.icon}
                alt={item.title}
              ...
              <section className="space-y-2">
                <h3 className="text-xl font-semibold text-[#1B233D] mb-2">
                  {item.title}
                </h3>
