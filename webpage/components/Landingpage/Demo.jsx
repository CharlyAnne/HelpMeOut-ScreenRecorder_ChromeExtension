  ...
  return (
    <section id="works" className="py-16 px-4 lg:px-16 xl:px-48">
      <div className="max-w-screen-xl mx-auto text-center mb-10">
        <h2 className="text-3xl lg:text-4xl font-bold text-[#141414] mb-2">
          How It Works
        </h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {steps.map((step, index) => (
          ...
          >
            <span className="text-2xl h-[45px] w-[45px] flex justify-center items-center font-semibold text-white bg-[#120B48] rounded-full mb-2">
              {step.number}
            </span>
            <h3 className="text-2xl font-semibold text-[#1B233D] mb-2">
              {step.title}
            </h3>
